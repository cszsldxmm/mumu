...
// MARK: question4
let image = try Data(contentsOf: URL(string: "https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1545118934256&di=fdb895cb5415f41d5327d4c92adff5bf&imgtype=0&src=http%3A%2F%2Fmeda.ntou.edu.tw%2Fshell%2Fthumb%2F1-0885-picture_800-534.png")!) //通过指定的url获取图片，并转换为二进制数据
